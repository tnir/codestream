...
import { CSCodeError, StreamType } from "@codestream/protocols/api";
...
export const createdAt = Date.now() - 1000;
		...
		stackTraces: [
			{
				...
				lines: [
					...
					},
					{
						...
						line: 802,
						error: "Unable to find matching file for path org/apache/coyote/AbstractProtocol.java",
					},
					{
						method: "doRun",
