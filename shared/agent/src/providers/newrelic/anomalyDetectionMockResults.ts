	...
	const methodGoldenMetrics = [
		{
			...
			result: [
				buildChartDataForNDaysAgo(10, null, null, "6.00"),
				buildChartDataForNDaysAgo(9, null, null, "6.00"),
				buildChartDataForNDaysAgo(8, null, null, "6.00"),
				buildChartDataForNDaysAgo(7, null, null, "6.00"),
				buildChartDataForNDaysAgo(6, null, null, "6.00"),
				buildChartDataForNDaysAgo(5, null, null, "6.00"),
				buildChartDataForNDaysAgo(4, null, null, "6.00"),
				buildChartDataForNDaysAgo(3, null, null, "12.00"),
				buildChartDataForNDaysAgo(2, null, null, "12.00"),
				buildChartDataForNDaysAgo(1, null, null, "12.00"),
			],
		},
		{
			...durationChartTemplate,
			result: [
				buildChartDataForNDaysAgo(10, "6.00", null, null),
				buildChartDataForNDaysAgo(9, "6.00", null, null),
				buildChartDataForNDaysAgo(8, "6.00", null, null),
				buildChartDataForNDaysAgo(7, "6.00", null, null),
				buildChartDataForNDaysAgo(6, "6.00", null, null),
				buildChartDataForNDaysAgo(5, "6.00", null, null),
				buildChartDataForNDaysAgo(4, "6.00", null, null),
				buildChartDataForNDaysAgo(3, "12.00", null, null),
				buildChartDataForNDaysAgo(2, "12.00", null, null),
				buildChartDataForNDaysAgo(1, "12.00", null, null),
			],
		},
		{
			...samplesChartTemplate,
			result: [
				buildChartDataForNDaysAgo(10, null, "6.00", null),
				buildChartDataForNDaysAgo(9, null, "6.00", null),
				buildChartDataForNDaysAgo(8, null, "6.00", null),
				buildChartDataForNDaysAgo(7, null, "6.00", null),
				buildChartDataForNDaysAgo(6, null, "6.00", null),
				buildChartDataForNDaysAgo(5, null, "6.00", null),
				buildChartDataForNDaysAgo(4, null, "6.00", null),
				buildChartDataForNDaysAgo(3, null, "6.00", null),
				buildChartDataForNDaysAgo(2, null, "6.00", null),
				buildChartDataForNDaysAgo(1, null, "6.00", null),
			],
		},
	...
	const methodGoldenMetrics = [
		{
			...
			result: [
				...
				buildChartDataForNDaysAgo(5, null, null, "6.00"),
				buildChartDataForNDaysAgo(4, null, null, "6.00"),
				buildChartDataForNDaysAgo(3, null, null, "6.00"),
				buildChartDataForNDaysAgo(2, null, null, "6.00"),
				buildChartDataForNDaysAgo(1, null, null, "6.00"),
			],
		},
		{
			...durationChartTemplate,
...
const anomalyDetectionMockResponseTemplate: GetObservabilityAnomaliesResponse = {
	responseTime: [
		{
			...
			oldValue: 163.33994469698774,
			newValue: 167.57051815030647,
			ratio: 1.0259004217319092,
			...
			chartHeaderTexts: {
				"Average duration (ms)": "+2.59% since release CS42 on $date",
			},
			notificationText: "Average duration (ms) +2.59% since release CS42 on $date",
	...
	errorRate: [
		{
			name: "Java/acme.storefront.action.PurchaseAction/checkout",
			oldValue: 2.232468106115,
			newValue: 2.732468106115,
			ratio: 1.22396736537039,
			codeFilepath: undefined,
			codeNamespace: "acme.storefront.action.PurchaseAction",
			codeFunction: "checkout",
			language: "java",
