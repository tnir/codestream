...
namespace CodeStream.VisualStudio.Shared.UI.Extensions
{
	public static class AnimationExtensions
	{
		public static UIElement FadeFromTo(
		...
		)
		{
			...
			if (collapseOnFinish)
			{
				var keyAnimation = new ObjectAnimationUsingKeyFrames
				{
					Duration = new Duration(timeSpan)
				};
				keyAnimation.KeyFrames.Add(
					new DiscreteObjectKeyFrame(Visibility.Collapsed, KeyTime.FromTimeSpan(timeSpan))
				);
