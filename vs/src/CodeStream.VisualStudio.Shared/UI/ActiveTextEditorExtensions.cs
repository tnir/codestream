...
namespace CodeStream.VisualStudio.Core.Adornments
{
	...
	{
		public static HighlightAdornmentManager GetHighlightAdornmentManager(
			this ActiveTextEditor editor
		)
		{
			if (editor == null || editor.WpfTextView == null)
				return null;

			HighlightAdornmentManager ham = null;
			if (
				editor.WpfTextView?.Properties.TryGetProperty(
