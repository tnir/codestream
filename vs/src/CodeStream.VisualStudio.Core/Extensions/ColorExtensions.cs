...
namespace CodeStream.VisualStudio.Core.Extensions
{
	...
	{
		public static System.Windows.Media.Color ConvertToMediaColor(
		...
		public static Color Lerp(this Color color, Color to, float amount)
		{
			...
			return Color.FromArgb(
				(byte)sr.Lerp(to.R, amount),
				(byte)sg.Lerp(to.G, amount),
				(byte)sb.Lerp(to.B, amount)
			);
		}
		...
		public static bool IsDark(this Color c2) =>
			(0.2126 * c2.R + 0.7152 * c2.G + 0.0722 * c2.B) < 128;
	}
}
